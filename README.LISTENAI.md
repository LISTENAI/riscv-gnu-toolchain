...
[Nuclei](https://github.com/riscv-mcu/riscv-gnu-toolchain) `nuclei/2025.02`
toolchain. Released for both Apple Silicon (arm64) and Intel (x86_64).

The feature set is kept in line with the official Nuclei/ARCS toolchain: GDB is
...
- Based on Nuclei `nuclei/2025.02`.
